...
Суть сервиса:
- Вы загружаете схему БД (таблицы, связи, usage).
- Сервис строит граф, считает baseline и расширенный “AI” разбор (эвристики + доменные правила).
- Возвращает метрики связности, объяснения доменов (включая LLM-описания) и сравнение baseline vs AI.
- По результату генерирует черновой план миграции: границы сервисов, карта владения таблицами и план шардирования.
